...
void main()
{
	...
	vec4 worldPos = ubo.modelMatrix * vec4(inPos, 1.0);
	...
	outWorldNormal = normalize(mat3(ubo.modelMatrix) * inNormal);
	vec3 worldTangent = normalize(mat3(ubo.modelMatrix) * inTangent);
